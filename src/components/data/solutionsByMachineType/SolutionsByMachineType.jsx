export const solutionsByMachineType = {
  ...
  pesaje: {
    ...
    ejes: {
      title: "Equipos de Pesaje - Ejes",
      characteristics: [
        "Diseñados para pesar vehículos o estructuras con precisión y robustez.",
        "Adaptables a diferentes configuraciones de carga y entornos de trabajo exigentes.",
      ],
      benefits: [
        "Alta durabilidad y resistencia en condiciones industriales.",
        "Fácil integración en sistemas de control y automatización.",
        "Precisión garantizada en diversas aplicaciones logísticas e industriales."
      ],
      PBP_30T: {
        title: "PBP 30 T",
        image: "/img/pesaje/pbp_30t.jpg",
        description:
          "El eje PBP 30 T está diseñado para el pesaje de cargas móviles con alta precisión. Ideal para aplicaciones industriales donde se requiere control eficiente del peso en tránsito.",
        typeOfForm: 'balanzasejes'
      },
      PBP_M_2PL_30T: {
        title: "PBP M-2PL-30T",
        image: "/img/pesaje/pbp_m_2pl_30t.jpg",
        description:
          "Sistema de pesaje de doble plataforma, modelo PBP M-2PL-30T, que ofrece una solución efectiva para el control de peso en operaciones de carga y descarga, garantizando una lectura precisa y estable.",
        typeOfForm: 'balanzasejes'
      },
      PBP_M_4PC_60T: {
        title: "PBP M-4PC-60T",
        image: "/img/pesaje/pbp_m_4pc_60t.jpg",
        description:
          "Diseñado con cuatro plataformas de carga, el PBP M-4PC-60T proporciona una distribución equilibrada del peso para operaciones de gran escala. Ideal para camiones o estructuras de gran volumen.",
        typeOfForm: 'balanzasejes'
      },
    },
  
    balanzas: {
      title: "Equipos de Pesaje - Balanzas",
      characteristics: [
        "Balanzas industriales de piso para múltiples capacidades y tamaños.",
        "Construcción robusta y precisa, ideales para uso continuo.",
      ],
      benefits: [
        "Versatilidad en el manejo de diferentes tipos de carga.",
        "Fácil mantenimiento y operación.",
        "Alta precisión en entornos industriales exigentes."
      ],
      PBP_40X40: {
        title: "PBP 40X40",
        image: "/img/pesaje/pbp_40x40.jpg",
        description:
          "Balanza de plataforma de 40x40 cm, ideal para pesaje de cargas medianas en espacios reducidos. Equilibrio entre tamaño compacto y eficiencia operativa.",
        typeOfForm: 'balanzas'
      },
      PBP_60X60: {
        title: "PBP 60X60",
        image: "/img/pesaje/pbp_60x60.jpg",
        description:
          "Plataforma de pesaje de 60x60 cm con sensores de alta precisión. Perfecta para líneas de producción o control logístico.",
        typeOfForm: 'balanzas'
      },
      PBP_100X100: {
        title: "PBP 100X100",
        image: "/img/pesaje/pbp_100x100.jpg",
        description:
          "Balanza de piso robusta de 100x100 cm, capaz de soportar cargas de gran volumen con excelente precisión y estabilidad.",
        typeOfForm: 'balanzas'
      },
      PBP_120X120: {
        title: "PBP 120X120",
        image: "/img/pesaje/pbp_120x120.jpg",
        description:
          "Diseñada para operaciones de pesaje industriales pesadas, la PBP 120X120 ofrece precisión y durabilidad en un diseño de gran formato.",
        typeOfForm: 'balanzas'
      },
      PBP_150X150: {
        title: "PBP 150X150",
        image: "/img/pesaje/pbp_150x150.jpg",
        description:
          "Plataforma de pesaje de alta capacidad, ideal para procesos logísticos exigentes. Su tamaño de 150x150 cm permite pesar objetos de gran tamaño con facilidad.",
        typeOfForm: 'balanzas'
      },
    },
  
    dosificadoras: {
      title: "Equipos de Pesaje - Dosificadoras",
      characteristics: [
        "Diseñadas para el pesaje y dosificación precisa de materiales.",
        "Controlan el flujo de producto en procesos automáticos de producción.",
      ],
      benefits: [
        "Mejora en la eficiencia del proceso de mezcla o envasado.",
        "Reducción de desperdicio de material.",
        "Control preciso por lote o continuo según requerimiento."
      ],
    },
  
    pesaje_continuo: {
      title: "Equipos de Pesaje - Pesaje Continuo",
      characteristics: [
        "Pesaje dinámico de materiales en movimiento para líneas de producción.",
        "Integración con sistemas de control para monitoreo en tiempo real.",
      ],
      benefits: [
        "Mayor eficiencia en procesos continuos.",
        "Automatización del control de calidad y producción.",
        "Reducción de errores humanos y variabilidad de pesaje."
      ],
      PCS_1_10: {
        title: "PCS 1-10",
        image: "/img/pesaje/pcs_1_10.jpg",
        description:
          "Sistema de pesaje continuo PCS 1-10 para materiales de bajo flujo. Ideal para procesos de precisión en laboratorios o líneas piloto.",
        typeOfForm: 'pesajecontinuo'
      },
      PCS_35_50: {
        title: "PCS 35-50",
        image: "/img/pesaje/pcs_35_50.jpg",
        description:
          "El PCS 35-50 es un equipo de pesaje dinámico de mediana capacidad, diseñado para integrarse en procesos industriales automatizados.",
        typeOfForm: 'pesajecontinuo'
      },
      PCS_50_100: {
        title: "PCS 50-100",
        image: "/img/pesaje/pcs_50_100.jpg",
        description:
          "Equipo de pesaje continuo de alta capacidad, el PCS 50-100 está preparado para líneas de producción con gran volumen de material, manteniendo una precisión constante en tiempo real.",
        typeOfForm: 'pesajecontinuo'
      },
    },
  }
