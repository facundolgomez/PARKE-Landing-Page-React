    ...
    <>
      ...
      {loading ? (
        <div className="flex justify-center my-4 text-3xl font-mono font-bold text-sky-600">
          <p className="me-4">CARGANDO NOVEDADES</p>
          <div role="status">
      ...
      {emptyNews && (
        <h3 className="flex justify-center my-3 text-3xl font-bold font-mono text-sky-600 ">NO HAY NOVEDADES EN ESTE MOMENTO</h3>
      )}
    </>
  );
};
